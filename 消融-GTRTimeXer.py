...
num_epochs =200  # 训练迭代次数 300论以后趋于稳定 0.001+500最佳 这个别改 loss维持再0.0010徘徊
...
model_type = 'GTRTimeXer'
net = GTRTimeXer.Model(config).to(device)
